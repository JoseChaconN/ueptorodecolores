...
$pdf->Image('assets/img/logo.png',10,10,23,25);
$pdf->Image('imagenes/planilla.jpg',1,40,210,245);
if($a==1)
{
	$pdf->SetFont('Times','',9);
	$pdf->Cell(25);
	...
	$pdf->Cell(5);
	$pdf->Cell(30,5,'Estudiante',0,1,'C');
	$pdf->Cell(80);
	$pdf->SetFont('Arial','B',12);
	$pdf->SetX(10);
	$pdf->Cell(190,5, utf8_decode('PLANILLA DE PRE-INSCRIPCIÓN '),0,1,'C');
	$pdf->Cell(190,5, utf8_decode($planilla).' '.$nombre_periodo,0,1,'C');
