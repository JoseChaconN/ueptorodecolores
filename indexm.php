...
<head>
  	...
  	<link href="assets/css/style.css?0.3" rel="stylesheet">
...
<body>
  	...
  	<header id="header" class="fixed-top">
	  	<div class="container d-flex align-items-center">
	      	...
	      	<h4 class="logox me-auto"><a href="index.php"><img id="logoColegio" src="assets/img/logo.png?6" style="width:10%; height: auto;"><span id="colegio" style="color: #FFF;">U.E.P. El Toro de Colores</span></a></h4>
	      	<nav id="navbar" class="navbar order-last order-lg-0">
	        	<ul><?php
	      			...
	      			if(isset($_SESSION["usuario"])) 
	      			{ ?> 
		          		<li><a href="#publica">Comunicados</a></li>
				                ...
				                if ($habi==1) {?>
				              		<li class="dropdown"><a href="#"><span>Documentos</span> <i class="bi bi-chevron-right"></i></a>
					                	<ul>
					                  		...
					                  		<li><a href="cons-ins.php" target="_blank">Constancia de Inscripción</a></li>
				              	...
				              	<li class="dropdown"><a href="#popular-courses"><span>Aula Virtual</span> <i class="bi bi-chevron-right"></i></a>
			                		<ul>
				                  		...
				                  		<li><a href="list-tareas-pri.php">Material de clases</a></li>
  	...
  	<main id="main">
	        ...
	        <div class="row"><?php
	  			...
	  			{ ?> 
					<div class="col-lg-4 d-flex align-items-stretch">
						<div class="content">
						  <h3>Pre Inscripción <?= PROXANOE ?></h3>
		        ...
		        <div class="col-lg-<?= $grande ?> d-flex align-items-stretch" data-aos="zoom-in" data-aos-delay="100">
		            <div class="icon-boxes d-flex flex-column justify-content-center">
		              <div class="row"><?php
		  				if(isset($_SESSION["usuario"])) 
		  				{ ?>
			              	<div class="col-xl-12 col-12 col-md-12 d-flex align-items-stretch">
			                  <div class="icon-box mt-4 mt-xl-0">
			                  	<i class="bx bx-receipt"></i>
			                    <h4>Perfil</h4>
			                    <p>Datos personales Estudiante</p>
		                ...
		                <div class="col-xl-12 col-12 col-md-12 d-flex align-items-stretch">
		                  <div class="icon-box mt-4 mt-xl-0">
		                    ...
		                    <h4>Pagos</h4>
		                    <p>Notifique sus pagos electrónicos</p><?php 
							if(!isset($_SESSION["usuario"])) 
							{ ?>
		      ...
		      <div class="container" data-aos="fade-up">
		        ...
		        <div class="row" data-aos="zoom-in" data-aos-delay="100">
		          	<div class="col-lg-3 col-md-4 mt-4">
			            ...
			            <div class="icon-box">
			              <i class="ri-question-line" style="color: #b20969;"></i>
			        ...
			        <div class="col-lg-3 col-md-4 mt-4">
		          	...
		          	<div class="col-lg-3 col-md-4 mt-4">
			            <div class="icon-box">
			              ...
			              <h3><a href="planilla.php" target="_blank">Planilla de Inscripción</a></h3>
			            </div>
		          	</div>
		          	<div class="col-lg-3 col-md-4 mt-4">
			            <div class="icon-box">
			              <i class="ri-newspaper-line" style="color: #5578ff;"></i>
			              <h3><a href="cons-ins.php" target="_blank">Constancia de Inscripción</a></h3>
			            </div>
		          	</div>
		          	<div class="col-lg-3 col-md-4 mt-4">
			            <div class="icon-box">
			              <i class="ri-file-mark-line" style="color: #e80368;"></i><?php 
		              		if($morosida>0 || $pagado==0)
		              		{ ?>
			              		<h3><a onclick="msjMoro()" style='cursor: pointer'>Constancia de Estudio</a></h3><?php 
			              	}else
			              	{?>
			              		<h3><a href="cons-est.php" target="_blank">Constancia de Estudio</a></h3><?php 
			              	}?>
		            	</div>
		          	</div>
		          	<div class="col-lg-3 col-md-4 mt-4">
			            <div class="icon-box">
			              ...
			              <h3><a href="motivo.php">Constancia de Asistencia</a></h3>
			            </div>
		          	</div>
		          	<div class="col-lg-3 col-md-4 mt-4">
			            <div class="icon-box">
			              <i class="ri-shield-user-line" style="color: #47aeff;"></i><?php 
		              		if($morosida>0 || $pagado==0)
		              		{ ?>
			              		<h3><a onclick="msjMoro()" style='cursor: pointer'>Carnet de Estudio</a></h3><?php 
			              	}else
			              	{?>
			              		<h3><a href="carnet.php" target="_blank">Carnet de Estudio</a></h3><?php 
			              	}?>
			            </div>
		          	</div>
		          	<div class="col-lg-3 col-md-4 mt-4">
			            <div class="icon-box">
			              <i class="ri-file-list-3-line" style="color: #11dbcf;"></i><?php 
			              	...
			              	{?>
			              		<h3><a href="boletas.php">Boletin de Calificaciones</a></h3><?php 
			              	}?>
			            </div>
		          	</div>
		          	<div class="col-lg-3 col-md-4 mt-4">
			            <div class="icon-box">
			              ...
			              <h3><a href="encuesta-lista.php">Encuesta <?= PROXANOE ?></a></h3>
			            </div>
		          	</div>
					<div class="col-lg-3 col-md-4 mt-4">
	    ...
	    <!-- ======= Bancos Section ======= -->
	    <section id="bancos" class="pricing">
	      	<div class="container" data-aos="fade-up">
	      		<div class="section-title">
		          	<h2>Pagos</h2>
	    ...
	    </section><!-- End Pricing Section --><?php
			...
			<section id="publica" class="about">
				<div class="container" data-aos="fade-up">
					<div class="section-title" style="margin-top:1px;">
			          <h2>Información</h2>
			          <p>Comunicados</p>
			          <a href="publicacion.php" target="_blank" ><button type="button" class="get-started-btn"  ><span class="fa fa-eye" aria-hidden="true" ></span> Ver Todas</button></a>
			        </div>
					<style type="text/css">
						.error
					    { 
					...
					if(mysqli_num_rows($query) > 0 )
				    {
						while($row=mysqli_fetch_array($query) ) 
					    {
					        ...
					        $nom_doc=utf8_encode($row['nombre_archivo']); ?>
							<div align="center" class="error"><?php echo $titulo; ?><br><?php echo $descripcion?>
							</div>
							<div align="center" class="embed-container">
								<iframe src="archivos/<?php echo $nom_doc; ?>" frameborder="0" allowfullscreen width="560" height="315"  ></iframe>
				            </div><?php
							/*$son=$son+1;
					        if($son==2){ break; }*/
					    }
	...
	if(isset($_SESSION['usuario']))
	{?>
	  	<button class="btn btn-success btn-float " onclick='location.href="contactoPri.php"' ><i class="fas fa-comments fa-2x"></i>&nbsp;&nbsp;</button><?php 
	}?>
  	<!-- ======= Footer ======= -->
  	<footer id="footer">
	        ...
	        <div class="row">
	          ...
	          <div class="col-lg-3 col-md-6 footer-links">
	            ...
	            <ul>
		            ...
		            if(isset($_SESSION['usuario']))
		            {?>
	              		<li><i class="bx bx-chevron-right"></i> <a href="list-tareas-pri.php">Ver Material</a></li>
	              	...
	              	{?>
	              		<li><i class="bx bx-chevron-right"></i><a data-bs-toggle="modal" data-bs-target="#login1" style="cursor: pointer;"> Ver Material</a></li>
	    ...
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
	        <form method="post" action="login.php" >
	        	<center><img src="assets/img/logo.png?6" style="width:35%; "></center>
	          <div class="mb-3">
	            <label for="recipient-name" class="col-form-label"><i class="ri-user-follow-line"></i> Cedula ó Usuario Estudiante:</label>
	          ...
	          <div class="mb-3">
	            ...
	            <input type="hidden" name="dispo" value="movil">
	          </div>
	          <div class="col-md-12">
	  	...
	  	<div class="modal-dialog modal-dialog-scrollable">
	    	<div class="modal-content">
	      		...
	      		<div class="modal-body">
	        		<div class="col text-center">
			            <h3>Hola!</h3>
		              	<h4 id="nomAlumno" ></h4>
		              	<h2>Bienvenido(a)</h2>
		              	<img src="assets/img/logo.png?6" style="width:35%;">
	      		...
	      		<div class="modal-footer"><?php 
	        		...
	        		<a href="list-tareas-pri.php" id="botonAula" style="display: none;"><button type="button" class="btn btn-info">Ver Material</button></a>
