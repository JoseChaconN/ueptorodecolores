...
<html lang="es"><?php
  ...
  $docente_query=mysqli_query($link,"SELECT A.ruta,A.correo,A.nombre,A.apellido, B.nombremate FROM alumcer A, materiass".$tablaPeriodo." B WHERE A.idAlum='$idDocente' and B.codigo='$idMateria' "); 
    ...
    <section id="about" class="about" style="background-color:#E0E0E0; margin-top: 2%;">
      <div class="container" data-aos="fade-up">
        <div class="row">
          ...
          <?php 
          $chat_query=mysqli_query($link,"SELECT * FROM chat WHERE idAlum='$idAlum' and id_docente='$idDocente' and id_materia='$idMateria' ORDER BY fecha_chat DESC"); 
          ?>
          <form role="form" method="POST" enctype="multipart/form-data" action="" >
            ...
            <input type="hidden" id="correo" value="<?= encriptar($correoDoc) ?>">
          </form>
