...
if(isset($_SESSION['usuario']) && $_SESSION['cargo']>2)
{
    ...
    try {
      ...
      $mail->Body = $mensaje;
      $mail->send();
      mysqli_query($link,"INSERT INTO correo_docente (id_docente, idAlum, fecha, asunto, mensaje, archivo ) VALUE ('$idDoc','$idAlumno','$fechaHoy','$asunto','$mimensaje','$nombre_archivos' ) ") or die ("NO SE CREO ".mysqli_error($link));
    } catch (Exception $e) {
