            ...
            <tbody><?php  
              ...
              { 
                ...
                <tr>
                  ...
                  <td><?php 
                    if ($correoRep!="") {?>
                      <button type="button" title='Enviar Correo' onclick="enviaMail('<?= encriptar($idAlum) ?>')" data-bs-toggle="modal" data-bs-target="#enviarMail" class="btn btn-outline-primary" ><i class="bi-envelope" ></i></button><?php 
                    }?>
        ...
        <form role="form" method="POST" target="_blank" onsubmit="return validacion()" enctype="multipart/form-data" action="mailRepre.php">
          <div class="modal-body">
            <div class="col">
              <div class="row">
                <div class="col-md-12">
                    <input type="text" name="asunto" required id="asunto" placeholder="Asunto" class="form-control" maxlength="100" >
                </div>
