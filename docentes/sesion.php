...
<html lang="es"><?php
  if(isset($_POST['usuario']))
  {
    ...
    if($count>0)
    {
      $periodo_query=mysqli_query($link,"SELECT tablaPeriodo, nombre_periodo,lapsoPeriodo FROM  periodos where activoPeriodo='1'"); 
      while($row=mysqli_fetch_array($periodo_query))
      {
        ...
        $_SESSION['lapsoActivo']=$row['lapsoPeriodo'] ;
      }
    }
  }
            ...
            <form role="form" method="POST" enctype="multipart/form-data" action="" >
              <div style="margin-top: 2%;">
                ...
                <div class="col-md-4 offset-4 form-group">
                  <label for="recipient-name" class="col-form-label"><i class="ri-user-follow-line"></i> Cedula del Docente:</label>
