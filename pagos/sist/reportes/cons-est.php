...
if(isset($_SESSION['usuario']) && isset($_SESSION['password']))
{
    ...
    if ( $pagado==0 || $morosida>0 || empty($correo) || empty($ced_rep) || empty($gra_alu) || mysqli_num_rows($resultado)==0) 
    {
	...
	$pdf->AliasNbPages();
	$pdf->Addpage();
	$pdf->Image('assets/img/logo2.png',40,9,25,25);
	$pdf->Image('assets/img/fondoagua.jpg',15,65,160,180);
	...
	$pdf->Cell(30,6,utf8_decode('Educación Primaria - Media General '),0,1,'C');
	$pdf->Cell(80);
	$pdf->Cell(30,6,'RIF. '.RIFCOLM,0,1,'C');
	$pdf->Ln(10);
	$pdf->Cell(80);
	...
	$pdf->SetX(30);
	$pdf->Cell(160,8,'El   suscrito   Director    de   la   '.NKXS."  ".utf8_decode(EKKS),0,1,'L');
	...
	$pdf->Ln(10);
	$pdf->SetX(30);
	$pdf->Cell(160,8, utf8_decode('Constancia   que  se   expide  a   petición   del  representante,  en  '.CIUDADM.'  a  los ').strftime("%d  dias  del "),0,1,'L');
	$pdf->SetX(20);
	$pdf->Cell(170,8, strftime("mes de ".$mes." de %Y"),0,1,'L');
	$pdf->Ln(10);
	$pdf->SetX(120);
	...
	$pdf->SetX(120);
	$pdf->Cell(80,6, 'Director(a).',0,1,'L');
	$pdf->SetFont('Times','',9);
	$pdf->Ln(51);
	$pdf->SetX(10);
