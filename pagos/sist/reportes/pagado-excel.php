...
if ($grado>0) {
    ...
    $montos_query=mysqli_query($link,"SELECT * FROM montos".$tablaPeriodo." where id_grado='61' "); 
}
$va=1;
...
if($grado==0 && $secci==0){
    $alumnos_query=mysqli_query($link,"SELECT A.idAlumno,A.desc1,A.desc2,A.desc3,A.desc4,A.desc5,A.desc6,A.desc7,A.desc8,A.desc9,A.desc10,A.desc11,A.desc12,A.desc13,A.grado, B.nacion, B.cedula, B.apellido, B.nombre, B.ced_rep, C.nombreGrado as nomGra, D.nombre as nombreSeccion FROM matri".$tablaPeriodo." A, alumcer B, grado".$tablaPeriodo." C, secciones D where A.statusAlum='1' and A.idAlumno=B.idAlum and A.idSeccion=D.id and A.grado=C.grado ORDER BY A.grado, A.idSeccion, B.apellido"); 
}
if($grado==0 && $secci>0){
    $alumnos_query=mysqli_query($link,"SELECT A.idAlumno,A.desc1,A.desc2,A.desc3,A.desc4,A.desc5,A.desc6,A.desc7,A.desc8,A.desc9,A.desc10,A.desc11,A.desc12,A.desc13,A.grado, B.nacion, B.cedula, B.apellido, B.nombre, B.ced_rep, C.nombreGrado as nomGra, D.nombre as nombreSeccion FROM matri".$tablaPeriodo." A, alumcer B, grado".$tablaPeriodo." C, secciones D where A.statusAlum='1' and A.idAlumno=B.idAlum and A.idSeccion=D.id and A.grado=C.grado and A.idSeccion='$secci' ORDER BY A.grado, A.idSeccion, B.apellido"); 
}
if($grado>0 && $secci==0){
...
if($resultado->num_rows > 0 )
{
	...
	$tituloReporte = "Bachillerato Montos Pagados Periodo Escolar ".$nombrePeriodo;
    $titulosColumnas = array('Apellido','Nombre','Año','Telefono','Insc.','Sep.','Oct.','Nov.','Dic.','Ene.','Feb.','Mar.','Abr.','May.','Jun.','Jul.','Ago.');
