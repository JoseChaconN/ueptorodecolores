                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody><?php 
                        ...
                        while($row=mysqli_fetch_array($query)) 
                        {
                            ...
                            $nomMoneda = ($moneda== 1) ? 'Bolivares' : 'Dolares'; ?>
                            <tr id="linea<?= $son ?>">
                                <td><?= $son; ?></td>
            ...
            <div class="modal-body">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <label>Moneda:</label>
                            <select class="form-control" id="monedaNuevo">
...
<script type="text/javascript">
    ...
    function  guardaConcepto()
    {
        ...
        sta=$('#statusNuevo').val();
        mon=$('#monedaNuevo').val()
        $.post('caja-chica-guarda.php',{'nombre':nom, 'stat':sta,'mone':mon},function(data)
        {
            if(data.isSuccessful)
            {
