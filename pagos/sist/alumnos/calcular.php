...
if($gradoVer=='0' || $secciVer=='0')
{
    ...
    $query = mysqli_query($link,"SELECT A.idAlum, D.statusAlum, A.cedula as 'cedalu',A.nombre as 'nomalu', A.ced_rep, B.nombreGrado as 'nomgra', A.apellido, D.grado, D.idSeccion, D.pagado, C.nombre as 'nomsec' FROM alumcer A, grado".$tablaPeriodo." B, secciones C, matri".$tablaPeriodo." D WHERE A.idAlum=D.idAlumno and 
...
<div class="container-fluid">
    ...
    <div class="form-row">
        <div class="col-md-6">
            <h1 class="h3 mb-2 text-gray-800">Listado de Estudiantes </h1>    
        </div>    
        <div class="col-md-3">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody><?php 
                        ...
                        while($row=mysqli_fetch_array($query)) 
                        {
                            ...
                            $son++;
                            $ced_rep=$row['ced_rep'];
                            $represe_query = mysqli_query($link,"SELECT representante,correo FROM represe WHERE cedula='$ced_rep' ");
                            ...
                            <tr id="linea<?= $son ?>">
                                ...
                                <td>
                                    <div class="dropdown mb-4 btn-group">
                                        ...
                                        if($correo!='' && $url_actual!='localhost')
                                        {?>
