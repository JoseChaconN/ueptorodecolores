...
}else
{
    ...
    $matri_query = mysqli_query($link,"SELECT retiraPagos,grado,idSeccion,desc1,desc2,desc3,desc4,desc5,desc6,desc7,desc8,desc9,desc10,desc11,desc12,desc13,suma_a_pagado FROM matri".$tablaPeriodo." WHERE idAlumno ='$idAlum' "); 
    $totDesc=0;
        ...
        <div class="card-body">
            <form role="form" method="POST" onsubmit="return validacion();" enctype="multipart/form-data" <?php if($guarda=='nuevo'){echo 'action="alumno-nuevo.php"';}else{echo 'action="alumno-actual.php"';} ?> >
                ...
                <div class="form-row" style="background-color: #FFF9C4; padding: 5px;">
                    ...
                    <div class="col-md-3 col-xs-6 col-sm-3" id="divGrado">
                        ...
                        <select name='gra_alu' id='gra_alum' class="form-control">
                            ...
                            $select1 = mysqli_query($link,"SELECT grado, nombreGrado FROM grado".$tablaPeriodo." WHERE grado>60 ");
                ...
                <div class="form-row" style="margin-top:1%;">
                    ...
                    <div class="col-md-3" style="margin-top: 2%;">
                        <button type="button" <?php if($guarda=='nuevo'){echo  'disabled';} ?> onclick='window.open("../factura/facturar.php?id=<?= encriptar($idAlum).'&peri='.$tablaPeriodo.'&gra='.$grado ?>")' style="width: 100%;" id="btn-factura" class="btn btn-success"><i class="fas fa-dollar-sign fa-sm"></i> Facturar</button>
                    </div>  
                </div>
