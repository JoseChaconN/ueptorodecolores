...
$grado=$_POST['grado'];
$monto_query = mysqli_query($link,"SELECT A.idAlum,A.montoDolar,A.comentario FROM pagos".$tablaPeriodo." A, conceptos B WHERE recibo ='$recibo' and B.afecta='S' and A.id_concepto=B.id ");
$restaPagado=0;
...
mysqli_query($link,"UPDATE pagos".$tablaPeriodo." SET statusPago='1',comentario='$motivo' WHERE recibo='$recibo' ") or die ("NO ACTUALIZO ".mysqli_error());
if($restaPagado>0)
{
	if($grado<61)
	{
