...
<html lang="es">
  ...
  $videos_query = mysqli_query($link,"SELECT A.tituloVideo, A.descriVideo, A.fechaPublica, A.videoLink1, A.videoLink2, A.videoLink3, A.videoLink4, A.idVideo, A.lapsoVideo, B.nombremate, C.nombre, C.apellido, D.nombreGrado, E.nombre as nomSec FROM video".$periodoAlum." A, materiass".$periodoAlum." B, alumcer C, grado".$periodoAlum." D, secciones E WHERE A.codGrado='$idGra' and A.codSecci='$idSec' and A.codMater=B.codigo and A.cedProf=C.cedula and A.fechaPublica<='$fechahoy' and A.codGrado=D.grado and A.codSecci=E.id  ORDER BY A.fechaPublica DESC"); ?>
  ...
  <main id="main">
    ...
    <div class="modal fade" id="comentarios" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog modal-lg" >
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLongTitle">Comentarios del Docente:</h3>
          ...
          <form role="form" method="POST" action="" enctype="multipart/form-data">
            <div class="modal-body">
              <div class="row">
                <div class="col-md-8">
                  <label>Docente:</label>
                  <input type="text" class="form-control" readonly id="docenteCom">
                </div>
                <div class="col-md-4">
                  <label>Grado:</label>
                  <input type="text" class="form-control" readonly id="gradoCom" >
                </div>
                <div class="col-md-12">
                  <label>Titulo Tarea:</label>
                  <input class="form-control" readonly="" type="text" id="tituloCom">
                </div>
                <div class="col-md-12">
                  <label>Descripcion:</label>
                  <input type="text" class="form-control" aria-describedby="basic-addon1" id="descriCom" readonly>
                </div>
                <div class="col-md-6">
                  <label>Fecha de Publicación</label>
                  <input type="date" readonly class="form-control" id="publicaCom">
                </div>
                <div class="col-md-6">
                  <label>Maxima de Recepción</label>
                  <input type="date" readonly class="form-control" id="maximaCom">
                </div>
                <div class="col-md-12 col-xs-12 col-sm-12" >
                  <label>Comentarios:</label>
                  <textarea class="form-control" readonly="" rows="6" id="comentaCom" name="comentaCom"></textarea>
                </div>
              </div>
            </div>
            <div class="modal-footer">
              <div class="col-md-4 col-md-offset-8">
                <button type="button" class="btn btn-rectangular btn-success" style="color: #000; width: 100%;" data-bs-dismiss="modal" aria-label="Close">Cerrar</button>
              </div>
            </div>
          </form>
        </div>
